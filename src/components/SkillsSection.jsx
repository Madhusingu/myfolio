...
const skills = [
  ...
  { name: "Core Java", level: 50, category: "languages" },
  { name: "HTML", level: 80, category: "languages" },
  { name: "CSS", level: 80, category: "languages" },
  
  // Backend
  { name: "Django", level: 60, category: "frameworks" },
  { name: "Scikit-Learn", level: 65, category: "frameworks" },
  { name: "TensorFlow", level: 70, category: "frameworks" },
  { name: "PyTorch", level: 65, category: "frameworks" },
